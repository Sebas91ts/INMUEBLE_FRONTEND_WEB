  ...
  const registrosFiltrados = registros.filter((r) => {
    return (
      ...
      (!filtros.nombreUsuario ||
        r.nombreUsuario
          .toLowerCase()
          .includes(filtros.nombreUsuario.toLowerCase())) &&
      (!filtros.grupoUsuario ||
        r.grupoUsuario
          .toLowerCase()
          .includes(filtros.grupoUsuario.toLowerCase()))
    )
  })
    ...
    <div className='p-4'>
      ...
      <div className='mb-4 flex gap-2'>
        ...
        <input
          ...
          onChange={(e) =>
            setFiltros({ ...filtros, idUsuario: e.target.value })
          }
          className='border p-2 rounded'
        />
        <input
          ...
          onChange={(e) =>
            setFiltros({ ...filtros, nombreUsuario: e.target.value })
          }
          className='border p-2 rounded'
        />
        <input
          ...
          onChange={(e) =>
            setFiltros({ ...filtros, grupoUsuario: e.target.value })
          }
          className='border p-2 rounded'
        />
      </div>
